...
- **Gradio UI:** [`automl-engineer-agent-oss/app.py`](automl-engineer-agent-oss/app.py); root [`app.py`](app.py) stays in sync for flat deploys (e.g. [Explainable_ML-Pipeline-Agent](https://github.com/Abdrakib/Explainable_ML-Pipeline-Agent)).
- **Streamlit UI:** [`automl-engineer-agent`](automl-engineer-agent/) (`streamlit run app.py` there).
